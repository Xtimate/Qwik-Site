  ...
  <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
    <div class="mx-auto max-w-3xl text-center">
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-4">
        ...
        <a
          class="block w-full bg-transparent rounded border border-blue-600 transition duration-1000 px-12 py-3 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto"
          href="#"
        >
          Learn More
        </a>
